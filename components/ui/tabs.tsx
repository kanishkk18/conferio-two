...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "dark:bg-[#1D1D1D] bg-[#f3f1f1] dark:text-[#D4D4D4] inline-flex px-0.5 h-9 w-fit items-center justify-center rounded-xl ",
        className
      )}
      {...props}
    />
