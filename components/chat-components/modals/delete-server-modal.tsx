...
//               Cancel
//             </Button>
//             <Button variant="default" disabled={isLoading} onClick={onClick}>
//               Confirm
//             </Button>
//           </div>
//         </DialogFooter>
...
// export function ServerHeader({ server, role, channelType, serverId }: ServerHeaderProps) {
...
//       useEffect(() => {
//         if (server) {
//           serverform.setValue("name", server.name);
//           serverform.setValue("imageUrl", server.imageUrl);
//         }
//       }, [server, serverform]);
...
//           const onSubmitChannel = async (values: z.infer<typeof channelformSchema>) => {
//             try {
//               const url = qs.stringifyUrl({
//                 url: "/api/channels",
//                 query: { serverId }
...
//                     </DialogHeader>
//                     <Form {...form}>
//                       <form onSubmit={form.handleSubmit(onSubmitChannel)} className="space-y-8">
//                         <div className="space-y-8 px-6">
//                           <FormField
//                             control={form.control}
//                             name="name"
...
//                           Cancel
//                         </Button>
//                         <Button onClick={onClick} variant="default" disabled={isLoading}>
//                           Confirm
//                         </Button>
//                       </div>
//                     </DialogFooter>
