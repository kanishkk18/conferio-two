...
function TooltipContent({
  ...
  return (
    <TooltipContentPrimitive
      className={cn(
        'z-50 w-fit bg-[#5C47CD] text-primary-foreground rounded-md',
        className,
      )}
      {...props}
    >
      ...
      <TooltipArrowPrimitive
        className="!fill-[#5C47CD] size-3 data-[side='left']:translate-y-[1px] data-[side='right']:translate-x-[1px] data-[side='left']:translate-x-[-1px] data-[side='top']:translate-y-[-1px]"
        tipRadius={2}
      />
    </TooltipContentPrimitive>
  );
