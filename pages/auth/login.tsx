        ...
        <div className="space-y-3">
          ...
          {authProviders.saml && (
            <Link href="/auth/sso" className="btn btn-outline w-full">
              ...
              {/*  https://huly.io/videos/pages/auth/bg.mp4?updated=20240620146606  https://huly.io/_next/static/media/2ee582ff1de332ce1b830df95b3f8bde.svg  https://huly.io/_next/static/media/93487f9e8d46edd000f02623354df5e1.svg  https://huly.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fform-pattern.270a3962.jpg&w=1080&q=99 <div class="absolute top-1/2 h-[103px] w-[204px] -translate-y-1/2 bg-[radial-gradient(43.3%_44.23%_at_50%_49.51%,_#FFFFF7_29%,_#FFFACD_48.5%,_#F4D2BF_60.71%,rgba(214,211,210,0.00)_100%)] blur-[5px]"></div> */}
